...
if "!OLLAMA_OK!"=="1" (
    ...
    REM Modelo para respuestas en ingles (si esta definido y es distinto)
    if defined OLLAMA_MODEL_ENGLISH (
        if "!OLLAMA_MODEL_ENGLISH!" neq "!OLLAMA_MODEL!" (
            if "!OLLAMA_MODEL_ENGLISH!" neq "!OLLAMA_MODEL_FAST!" (
                call :pull_if_missing "!OLLAMA_MODEL_ENGLISH!"
            )
        )
    )
    ...
    if defined OLLAMA_MODEL_MEDIUM (
        if "!OLLAMA_MODEL_MEDIUM!" neq "!OLLAMA_MODEL!" (
            if "!OLLAMA_MODEL_MEDIUM!" neq "!OLLAMA_MODEL_FAST!" (
                if "!OLLAMA_MODEL_MEDIUM!" neq "!OLLAMA_MODEL_ENGLISH!" (
        ...
        if "!OLLAMA_MODEL_SMART!" neq "!OLLAMA_MODEL!" (
            if "!OLLAMA_MODEL_SMART!" neq "!OLLAMA_MODEL_FAST!" (
                if "!OLLAMA_MODEL_SMART!" neq "!OLLAMA_MODEL_MEDIUM!" (
                    if "!OLLAMA_MODEL_SMART!" neq "!OLLAMA_MODEL_ENGLISH!" (
