...
set "CFG_MIN_TOP_SCORE=0.28"
set "CFG_STRICT_SPANISH=false"
set "CFG_CACHE_TTL=3600"
set "CFG_CACHE_MAX=200"
set "CFG_TOP_K=4"
set "CFG_MAX_QUERY=500"
set "CFG_MIN_RELEVANCE=0.18"
set "CFG_MAX_CHUNK=520"
...
echo OLLAMA_MODEL_ENGLISH=%CFG_OLLAMA_MODEL_ENGLISH%
...
echo STRICT_SPANISH_ONLY=%CFG_STRICT_SPANISH%
echo.
